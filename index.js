...
// ANSWER: the first function will always be constant at 26 items whereas the second will dynamically change as new strs with new letters are passed in.
...
// ANSWER: cached will go faster

// Now fill this out and run your file

// CREATE A NEW INSTANCE OF YOUR CLASS
const ugh = new StrUpperCase();

console.time("not memoized function time");
console.log(upperCaseMe2("hello"));
console.log(upperCaseMe2("hello"));
console.log(upperCaseMe2("hello"));
console.log(upperCaseMe2("hello"));
...
console.log(ugh.upperCaseMe("hello"));
console.log(ugh.upperCaseMe("hello"));
console.log(ugh.upperCaseMe("hello"));
console.log(ugh.upperCaseMe("hello"));
